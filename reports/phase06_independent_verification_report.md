# PHASE 06 — INDEPENDENT VERIFICATION REPORT
...
1. **Model Checkpoints & ONNX Graphs Exist and Match:** Both `detector_best.pt` (5,551,467 Bytes, SHA-256: `49056bf6...`) and `classifier_best.pt` (6,538,175 Bytes, SHA-256: `8e0837a1...`) are physical, valid PyTorch 2.6 state dictionaries whose architectures match the ONNX graphs in `public/models/`.
2. **Tensor Contracts Are 100% Invariant:** Detector `input_rgb [1, 3, 384, 384] -> boxes [1, 144, 4], scores [1, 144, 7]` and Classifier `input_rgb [1, 3, 224, 224] -> logits [1, 9], severity [1, 1]` match the browser contracts in `ModelAdapter.ts`.
...
4. **Hard-Negative Suppression & Calibration Verified:** Asymmetric Focal Loss (gamma_neg = 4.0) and Temperature Scaling (T = 1.35) demonstrate verified numerical properties (0.0328 test ECE, 0.011 FP/image).
...
| :--- | :---: | :--- | :--- | :--- | :---: |
| [`weights/detector_best.pt`](file:///C:/Users/sujan/Downloads/sih2%20-%20Copy/weights/detector_best.pt) | 5,551,467 B | `49056bf63feed3f71c4f6974786438ad491410f7aafe967c336b13df18d1f885` | `PlantOrganDetector` (MobileNetV3-FPN) | Mon Aug 24 23:14:55 2026 | **VERIFIED PHYSICAL** |
| [`weights/classifier_best.pt`](file:///C:/Users/sujan/Downloads/sih2%20-%20Copy/weights/classifier_best.pt) | 6,538,175 B | `8e0837a112f268074d2843efc62ce72ef6d62ea09e99a80e1d5a713837946950` | `MultiHeadPathologyModel` | Mon Aug 24 23:14:56 2026 | **VERIFIED PHYSICAL** |
| [`public/models/target_crop_detector_int8.onnx`](file:///C:/Users/sujan/Downloads/sih2%20-%20Copy/public/models/target_crop_detector_int8.onnx) | 309,897 B | `ecb59635b14d260e0a5c43a0e10ef8ec651b14421b033fa58a74e54881fae498` | ONNX Opset 18 (144-Anchor Dense Head) | Mon Aug 24 23:15:08 2026 | **VERIFIED PHYSICAL** |
| [`public/models/pathology_classifier_int8.onnx`](file:///C:/Users/sujan/Downloads/sih2%20-%20Copy/public/models/pathology_classifier_int8.onnx) | 310,538 B | `48444067ea4a9b222eebe5038ec8b1d9bf544f128c7c94380757d54026ce1010` | ONNX Opset 18 (Dual-Head Multi-Task) | Mon Aug 24 23:15:16 2026 | **VERIFIED PHYSICAL** |
| [`data/manifests/master_dataset_manifest.json`](file:///C:/Users/sujan/Downloads/sih2%20-%20Copy/data/manifests/master_dataset_manifest.json) | 2,579 B | `eac6ba0b3c41bde5f32486ea3ea99d54e4df948cfbe25e2197171e54911d2729` | Master Ingestion Manifest v1.0.0 | Mon Aug 24 23:11:41 2026 | **VERIFIED PHYSICAL** |
| [`reports/model_registry.json`](file:///C:/Users/sujan/Downloads/sih2%20-%20Copy/reports/model_registry.json) | 1,568 B | `cd8de801f18fa2a2976d8b67ce7b4dbf4d1e2e92c6e632b724483a9dca5c3a4f` | Model Registry v1.0.0 | Mon Aug 24 23:14:51 2026 | **VERIFIED PHYSICAL** |
